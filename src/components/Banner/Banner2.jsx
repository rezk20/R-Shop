import { BannerData2 } from "../constants";
      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center text-white rounded-3xl bg-brandGreen">
          ...
          <div className="p-6 sm:p-8">
            ...
            <h2
              data-aos="zoom-out"
              className="uppercase text-6xl lg:text-7xl font-bold text-gray-200  "
            >
              {BannerData2.title}
            </h2>{" "}
          ...
          <div className="flex flex-col justify-center gap-4 p-6 sm:p-8">
            ...
            <div data-aos="fade-up" className=" max-w-1/2">
              <Button text={"Shop Now"} bgColor="bg-brandBlue" />
            </div>
          </div>
        </div>
      </div>
